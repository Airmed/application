...
//		// Position the eye behind the origin.
       ...
       ////Yaki  Matrix.setLookAtM(mViewMatrix, 0, eyeX, eyeY, eyeZ, lookX, lookY, lookZ, upX, upY, upZ);
        ...
        //Matrix.scaleM(mViewMatrix, 0, 1.0f, 0.2f, 1.0f); //Yaki
    ...
    public void onSurfaceChanged(GL10 glUnused, int width, int height)
    {
      ...
      //  width = (int) (width/1f);  //yaki
        height = (int) (height/1.5f); //yaki height changed to fit into the screen
       ...
       /// Matrix.scaleM(mProjectionMatrix, 0, 1.0f, 0.15f, 1.0f); //yaki
    }
